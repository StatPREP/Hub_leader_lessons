...
1. Open up the [`r linear_app$name`](`r linear_app$url`) Little App. Select `NHANES` as the data frame and systolic blood pressure as the response variable. 

    * Find an explanatory variable that produces a regression line that slopes up.
    * Find another explanatory variable where the regression line slopes down. 

...
Steps (1)  and (2) are to find  out about the data frame: What is the unit of analysis  and what are the variables. A standard  place to get such information is the *codebook* for the data frame, which is the descriptive documentation about the data.

Go to the ***Codebook*** tab in the app. The documentation will appear. 

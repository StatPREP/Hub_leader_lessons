...
![](normal-pillow.jpg){ width=30% } ![](t-shirt3.jpg){ width=25% }
...
# Learning objectives for the normal distribution
...
If you teach calculus as well as statistics, you might be tempted to point to the inflection points if the normal curve. If you do so, it should be because you want to teach a lesson about inflection points. There is any particular relevance to statistics. 

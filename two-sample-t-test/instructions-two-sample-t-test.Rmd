...
GENERALLY, ask students to explore to find variables that show a difference at p < 0.05.

Ask students to explore to find variables that produce as low a p-value as they can. Compare the results of one group to another.

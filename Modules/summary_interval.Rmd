...
There are several ways to measure variation of a quantitative variable. The most commonly used in statistics the *standard deviation*. Another measure is the *95% summary interval*, which is perhaps easier to understand than the standard deviation. 
